          ...
          >
            <div className="px-4 pb-5 space-y-5">
              ...
              <p className="text-base text-[#1a1a18] leading-relaxed">
                위에 보이는 표는 <strong className="text-[#1a1a18]">'만세력'</strong> 또는 <strong className="text-[#1a1a18]">'사주팔자'</strong>라고 불러요.
                태어난 생년월일시 정보를 우주의 기운을 담은 문자로 변환한, 일종의 <strong className="text-[#1a1a18]">'인생 지도'</strong>와 같답니다.
                앞으로 펼쳐질 모든 풀이는 바로 이 지도에 담긴 비밀을 하나씩 풀어가는 과정이에요.
              </p>

              {/* 사주(四柱) 설명 */}
              <div className="space-y-2">
                <h4 className="text-base font-bold text-[#1a1a18] flex items-center gap-1.5">
                  <span className="text-base">📊</span> 사주(四柱) — 네 개의 기둥
                </h4>
                <p className="text-sm text-[#5a5a56] leading-relaxed">
                  오른쪽부터 <strong className="text-[#1a1a18]/90">연주(태어난 해)</strong>, <strong className="text-[#1a1a18]/90">월주(태어난 달)</strong>, <strong className="text-[#1a1a18]/90">일주(태어난 날)</strong>, <strong className="text-[#1a1a18]/90">시주(태어난 시간)</strong>라는 4개의 기둥을 세운 것이에요.
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[#5a5a56] leading-relaxed">
                  4개의 기둥마다 위(<strong className="text-[#1a1a18]/90">천간</strong>, 하늘의 기운)와 아래(<strong className="text-[#1a1a18]/90">지지</strong>, 땅의 기운)에 글자가 하나씩, 총 8개의 글자가 새겨져 있어요.
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-[#5a5a56] leading-relaxed mb-2">
                  각 글자의 배경색은 세상을 이루는 5가지 기본 에너지, <strong className="text-[#1a1a18]/90">오행(木, 火, 土, 金, 水)</strong>을 상징해요. 색깔만 봐도 어떤 기운이 많은지 한눈에 알 수 있죠!
                </p>
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  {/* 금(金) */}
                  <div className="flex items-center gap-3 bg-[#6a6a66]/10 border border-[#6a6a66]/20 rounded-xl px-3 py-2.5">
                    <div className="w-8 h-8 rounded-lg bg-[#6a6a66]/20 flex items-center justify-center shrink-0">
                      <span className="text-[#6a6a66] font-bold text-sm">金</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-bold text-[#6a6a66]">금(金) 쇠 — 회색</p>
                      <p className="text-xs text-[#5a5a56] mt-0.5">의리, 결단력, 이성, 마무리를 상징해요</p>
                    </div>
                  </div>

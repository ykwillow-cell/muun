    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">토정비결이란 무엇인가?</h2>
        </div>
        <div className="bg-black/[0.05] rounded-2xl p-6 md:p-8 border border-black/10">
          <p className="text-[#1a1a18] leading-relaxed mb-4">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">토정 이지함 선생은 누구인가?</h2>
        </div>
        <div className="bg-black/[0.05] rounded-2xl p-6 md:p-8 border border-black/10">
          <p className="text-[#1a1a18] leading-relaxed mb-4">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">토정비결 보는 방법</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-black/[0.05] rounded-2xl p-6 border border-black/10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[#1a1a18] m-0">상괘(上卦) 산출</h3>
            </div>
          ...
          <div className="bg-black/[0.05] rounded-2xl p-6 border border-black/10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[#1a1a18] m-0">중괘(中卦) 산출</h3>
            </div>
            <p className="text-[#5a5a56] text-sm leading-relaxed m-0">
          ...
          <div className="bg-black/[0.05] rounded-2xl p-6 border border-black/10">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[#1a1a18] m-0">하괘(下卦) 산출</h3>
            </div>
            <p className="text-[#5a5a56] text-sm leading-relaxed m-0">
        ...
        <div className="bg-black/[0.05] rounded-2xl p-6 border border-black/10 mt-4">
          <p className="text-[#1a1a18] leading-relaxed m-0">
      ...
      <section className="mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">토정비결을 현명하게 활용하는 법</h2>
        </div>

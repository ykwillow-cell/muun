...
// 결과 화면 하단 서비스 링크 (Compatibility.tsx에서 named import로 사용)
export function CompatibilityRelatedServices() {
  return (
    <RelatedServices
...
// 기본 export (호환성 유지)
const CompatibilityContent = CompatibilityRelatedServices;

 ...
 * ③ 관련 서비스 계층화: 1 Featured(평생사주) + 3 Small 구조로 변경
 */
...
const CompatibilityContent = () => {
  ...
  return (
    <>
      ...
      <div className="w-full">
        <div className="bg-white/80 backdrop-blur-sm border border-border/50 shadow-xl overflow-hidden rounded-2xl">
          ...
          <div className="p-6 pb-0">
            {/* ② 헤딩 컬러: text-primary → text-foreground */}
              ...
              <section>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    <Heart className="w-5 h-5 text-[--compatibility-accent,#E8387A] mt-1 flex-shrink-0" />
                    <div>
      ...
      {/* ③ 관련 서비스 — 1 Featured + 3 Small 계층 구조 */}
      <div className="w-full mt-6">
        ...
        <button
          ...
          className="w-full mb-3 p-5 bg-gradient-to-br from-pink-500/08 to-pink-500/03 border border-pink-500/25 rounded-2xl hover:border-pink-500/50 hover:shadow-md transition-all group text-left"
        >
        ...
        <div className="grid grid-cols-3 gap-2">
          {SMALL_SERVICES.map((service) => (
            <button
              ...
              className="p-3 bg-white/80 border border-border/50 rounded-2xl hover:border-pink-500/30 hover:bg-pink-500/05 transition-all group shadow-sm text-left"
            >

    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-xs font-bold tracking-[0.08em] uppercase text-purple-600/60">오늘의 사주 용어</span>
          <span className="px-1.5 py-0.5 rounded text-xs font-medium bg-purple-500/20 text-purple-700 border border-purple-500/30">{todayTerm.categoryLabel}</span>
        </div>
      ...
      <Link href="/fortune-dictionary" className="flex-shrink-0">
        <span className="flex items-center gap-0.5 text-xs text-purple-500/70 hover:text-purple-600 transition-colors whitespace-nowrap mt-0.5">

    ...
    <article className="prose prose-invert max-w-none">
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">평생사주란 무엇인가?</h2>
        </div>
      ...
      <section className="mb-12">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">평생사주로 알 수 있는 것들</h2>
        </div>
      ...
      <section className="mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-bold text-[#1a1a18] m-0">무운 평생사주의 특징</h2>
        </div>
        <div className="bg-gradient-to-br from-primary/10 to-purple-900/10 rounded-2xl p-6 md:p-8 border border-primary/20">
          <ul className="space-y-4 m-0 p-0 list-none">
            <li className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-[#1a1a18]">30년 경력 전문가의 해석 데이터</strong>
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary font-bold">✓</span>
              <div>
                <strong className="text-[#1a1a18]">현대적이고 이해하기 쉬운 해석</strong>
                <p className="text-[#5a5a56] text-sm mt-1 m-0">
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary font-bold">✓</span>
              <div>
                <strong className="text-[#1a1a18]">완전 무료, 회원가입 불필요</strong>
                <p className="text-[#5a5a56] text-sm mt-1 m-0">
            ...
            <li className="flex items-start gap-3">
              <span className="text-primary font-bold">✓</span>
              <div>
                <strong className="text-[#1a1a18]">철저한 개인정보 보호</strong>
                <p className="text-[#5a5a56] text-sm mt-1 m-0">

...
const metaData: Record<string, { title: string, description: string, h1?: string, services?: { href: string, label: string }[], bodyContent?: string }> = {
  ...
  const faqMap: Record<string, Array<{question: string; answer: string}>> = {
    ...
    '/daily-fortune': [
      { question: '오늘의 운세는 무료인가요?', answer: '네, 무운의 일별 운세는 100% 무료입니다. 회원가입이나 개인정보 저장 없이 생년월일만 입력하면 즉시 확인할 수 있습니다.' },
      { question: '일별 운세에서 무엇을 알 수 있나요?', answer: '오늘의 종합운, 재물운, 애정운, 건강운, 직업운과 함께 오늘의 행운의 방향성, 행운의 숫자, 행운의 색상을 사주팔자 기반으로 분석해드립니다.' },
      { question: '일별 운세는 매일 달라지나요?', answer: '네, 일별 운세는 매일의 일주(day pillar)에 따라 달라집니다. 같은 생년월일이라도 날마다 다른 운세를 확인할 수 있습니다.' },
      { question: '일별 운세는 언제 확인하는 게 좋은가요?', answer: '아침에 확인하는 것이 이상적입니다. 오늘의 운의 흐름을 미리 파악하고 중요한 일정이나 결정에 참고하세요.' }
    ],
    '/manselyeok': [
      { question: '만세력이란 무엇인가요?', answer: '만세력은 사주팔자를 연월일시로 정리한 동양의 달력 체계입니다. 개인의 생년월일시에 해당하는 사주팔자(년주, 월주, 일주, 시주)를 확인할 수 있습니다.' },
      { question: '만세력 조회는 무료인가요?', answer: '네, 무운의 만세력 서비스는 100% 무료입니다. 회원가입이나 개인정보 저장 없이 생년월일시만 입력하면 즉시 확인할 수 있습니다.' },
      { question: '만세력에서 무엇을 알 수 있나요?', answer: '사주팔자(년월일시 주), 오행(목화토금수) 구성, 천간지지 분석, 일주의 신살, 대운 등을 확인할 수 있습니다.' },
      { question: '양력과 음력 중 어떤 것을 선택해야 하나요?', answer: '일반적으로 양력을 선택하지만, 음력으로 태어난 경우 음력을 선택하세요. 확실하지 않다면 양력을 선택하는 것이 일반적입니다.' }
    ]
  };

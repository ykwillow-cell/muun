...
/**
 * 이름에 사용을 금지하는 한자 블랙리스트 (A~N 카테고리)
 *
 * 분류 기준:
 * A. 신체/생리: 이름에 쓰면 천박하거나 불쾌한 인상
 * B. 죽음/어둠/고통: 의미 자체가 불길하거나 불쾌함
 * C. 구속/형벌: 형구·감금을 뜻함
 * D. 부정적 뜻: 찢다·썩다·마르다·쓰레기 등
 * E. 동물/벌레: 이름에 쓰지 않는 동물 명칭
 * F. 식물: 이름에 쓰지 않는 식물 명칭 (꽃·나무 제외)
 * G. 전쟁/폭력: 싸움·폭력을 뜻함
 * H. 방향/위치: 단독 이름으로 어색한 방위·위치 글자
 * I. 숫자/단위: 숫자 자체가 이름에 들어가면 어색함
 * J. 날씨/자연현상 중 부정적인 것
 * K. 맛/냄새: 부정적 감각을 뜻함
 * L. 질병/신체 이상
 * M. 방위 글자: 東西南北은 이름에 쓰지 않음
 * N. 어조사/접속사/기타 단독 이름 부적절 글자
 *

...
export const POPULAR_HANJA_WEIGHT_FEMALE: Record<string, number> = {
  ...
  '瑞': 10, '允': 10, '書': 10,  // 서윤·서연·서아 등 최빈출
  '然': 9,   // 서연·가연·채연
  '智': 10, '知': 9, '宇': 8,   // 지우·지아·지윤 등
  '夏': 9, '河': 8,              // 하윤·하은·하린 등
  '賢': 8,                       // 서현·지현·아현 등
  '恩': 10,                      // 하은·지은·나은 등 최빈출
  '敏': 8, '旻': 8,              // 민서·민지·민채 등
  ...
  '菊': 7,   // 국화 국 (이름에 자주 쓰임)
  '梅': 8,   // 매화 매 (이름에 자주 쓰임)
  '桂': 7,   // 계수나무 계 (이름에 자주 쓰임)
  '菁': 7,   // 우거질 청 (이름에 자주 쓰임)
  '楓': 7,   // 단풍 풍 (이름에 자주 쓰임)
  '蓮': 8,   // 연꽃 련 (이름에 자주 쓰임)
  '玉': 8,   // 구슬 옥 (여성적 이미지)
  '琪': 7,   // 아름다운 옥 기 (여성적 이미지)
  '琳': 7,   // 아름다운 옥 림 (여성적 이미지)
  '瑜': 7,   // 아름다운 옥 유 (여성적 이미지)
  '瑾': 7,   // 아름다운 옥 근 (여성적 이미지)
  '璟': 7,   // 옥빛 경 (여성적 이미지)
  '希': 8,   // 바랄 희
  '喜': 7,   // 기쁠 희
  '悅': 8,   // 기쁠 열

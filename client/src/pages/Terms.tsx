    ...
    <div className="min-h-screen bg-background text-foreground pb-20">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-background/50 border-b border-black/10">
        <div className="container mx-auto max-w-[1280px] px-4 h-14 flex items-center">
          ...
          <h1 className="text-xl font-bold text-[#1a1a18]">이용약관</h1>
        </div>
      </header>
        ...
        >
          ...
          <Card className="bg-card border-black/10">
            <CardContent className="p-8 space-y-6 text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-[#1a1a18]">2. 서비스의 성격</h3>
                <p>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-[#1a1a18]">3. 이용자의 의무</h3>
                <p>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-[#1a1a18]">4. 서비스의 변경 및 중단</h3>
                <p>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-[#1a1a18]">5. 면책 조항</h3>
                <p>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-[#1a1a18]">6. 저작권</h3>
                <p>

                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input id="birthTime1" type="time" {...form.register("birthTime1")} className="h-11 bg-white/5 border-white/10 text-white rounded-xl focus:ring-pink-500/50 focus:border-pink-500 transition-all text-sm" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input id="birthTime2" type="time" {...form.register("birthTime2")} className="h-11 bg-white/5 border-white/10 text-white rounded-xl focus:ring-red-500/50 focus:border-red-500 transition-all text-sm" />
                      </div>
                    </div>
                  </div>
        ...
        >
          ...
          <section className="flex flex-col items-center justify-center space-y-4 py-4">
            ...
            <div className="relative w-36 h-36 md:w-44 md:h-44 mx-auto">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="text-[10px] md:text-xs text-pink-400 font-bold mt-0.5">{getScoreLabel(scores.total)}</span>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-2">
                <div className="w-5 h-5 rounded-full bg-pink-500 text-white text-[10px] font-bold flex items-center justify-center">1</div>
                <span className="text-sm font-bold text-pink-400">{name1}님의 사주</span>
              </div>
              <Card className="bg-white/5 border-white/10 rounded-xl overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <div className="w-5 h-5 rounded-full bg-red-500 text-white text-[10px] font-bold flex items-center justify-center">2</div>
                <span className="text-sm font-bold text-red-400">{name2}님의 사주</span>
              </div>
              <Card className="bg-white/5 border-white/10 rounded-xl overflow-hidden">
                <CardContent className="p-3 md:p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card className="bg-white/5 border-pink-500/20 rounded-xl overflow-hidden">
                  ...
                  <CardContent className="p-4 space-y-3">
                    <div>
                      <p className="text-[10px] text-white/40 mb-1">상징</p>
                      <p className="text-sm text-white/90">{personality1.nature} ({personality1.symbol})</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-green-400 mb-1">강점</p>
                    ...
                    <div>
                      <p className="text-[10px] text-red-400 mb-1">약점</p>
                      <div className="flex flex-wrap gap-1.5">
                ...
                <Card className="bg-white/5 border-red-500/20 rounded-xl overflow-hidden">
                  ...
                  <CardContent className="p-4 space-y-3">
                    <div>
                      <p className="text-[10px] text-white/40 mb-1">상징</p>
                      <p className="text-sm text-white/90">{personality2.nature} ({personality2.symbol})</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-green-400 mb-1">강점</p>
                      <div className="flex flex-wrap gap-1.5">
                ...
                {['木', '火', '土', '金', '水'].map((elem) => {
                  ...
                  return (
                    <div key={elem} className="space-y-1.5">
                      <div className="flex items-center justify-between">
                        <span className={`text-sm font-bold ${ELEMENT_TEXT[elem]}`}>{withReading(elem)}</span>
                        <span className="text-xs text-white/50">{name1}: {v1}개 / {name2}: {v2}개</span>
                      </div>
                      <div className="grid grid-cols-2 gap-1">
                        <div className="flex items-center gap-1">
                          <span className="text-[10px] text-pink-400 w-6">{name1.slice(0, 1)}</span>
                        ...
                        <div className="flex items-center gap-1">
                          <span className="text-[10px] text-red-400 w-6">{name2.slice(0, 1)}</span>
                          <div className="flex-1 h-2 bg-white/5 rounded-full overflow-hidden">
                            <motion.div
                              initial={{ width: 0 }}
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-2 mb-4">
              ...
              애정운 궁합
              <span className={`text-sm font-bold ${getScoreColor(scores.loveScore)}`}>({scores.loveScore}점)</span>
            </h2>
            <Card className="bg-white/5 border-white/10 rounded-xl overflow-hidden">
              <CardContent className="p-4 md:p-6 space-y-4">
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-2 mb-4">
              ...
              재물 궁합
              <span className={`text-sm font-bold ${getScoreColor(scores.wealthScore)}`}>({scores.wealthScore}점)</span>
            </h2>
            <Card className="bg-white/5 border-white/10 rounded-xl overflow-hidden">
              <CardContent className="p-4 md:p-6 space-y-4">
          ...
          <section>
            <h2 className="text-lg md:text-xl font-bold text-white flex items-center gap-2 mb-4">
              ...
              가정운 궁합
              <span className={`text-sm font-bold ${getScoreColor(scores.familyScore)}`}>({scores.familyScore}점)</span>
            </h2>
            <Card className="bg-white/5 border-white/10 rounded-xl overflow-hidden">
              <CardContent className="p-4 md:p-6 space-y-4">

                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        <ToggleGroupItem value="male" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          남성
                        </ToggleGroupItem>
                        <ToggleGroupItem value="female" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          여성
                        </ToggleGroupItem>
                      </ToggleGroup>
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <ToggleGroup
                        ...
                        className="w-full h-11 bg-white/5 p-1 rounded-xl border border-white/10 grid grid-cols-2 gap-1"
                      >
                        <ToggleGroupItem value="solar" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          양력
                        </ToggleGroupItem>
                        <ToggleGroupItem value="lunar" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          음력
                        </ToggleGroupItem>
                      </ToggleGroup>
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <ToggleGroup
                        ...
                        className="w-full h-11 bg-white/5 p-1 rounded-xl border border-white/10 grid grid-cols-2 gap-1"
                      >
                        <ToggleGroupItem value="no" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          미혼
                        </ToggleGroupItem>
                        <ToggleGroupItem value="yes" className="h-full rounded-lg data-[state=on]:bg-purple-500 data-[state=on]:text-white text-white/70 transition-all font-medium text-sm">
                          기혼
                        </ToggleGroupItem>
                      </ToggleGroup>
                    </div>
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="bg-pink-500/5 border border-pink-500/10 rounded-xl p-3">
                      <p className="text-xs font-bold text-pink-400 mb-1">연애 스타일</p>
                      <p className="text-xs text-white/70 leading-relaxed">{stemPersonality.loveStyle}</p>
                    </div>
                    <div className="bg-blue-500/5 border border-blue-500/10 rounded-xl p-3">
                      <p className="text-xs font-bold text-blue-400 mb-1">직업 스타일</p>
                      <p className="text-xs text-white/70 leading-relaxed">{stemPersonality.workStyle}</p>
                    </div>
                  </div>
          ...
          <AnimatePresence>
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{fortunes.earlyLife.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {fortunes.midLife && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{fortunes.midLife.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {fortunes.lateLife && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{fortunes.lateLife.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {fortunes.wealth && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{fortunes.wealth.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {fortunes.career && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{fortunes.career.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {loveFortune && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{loveFortune.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}
            ...
            {healthFortune && (
              ...
              >
                ...
                <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                  <CardContent className="p-4">
                    <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{healthFortune.content}</p>
                  </CardContent>
                </Card>
              </motion.section>
            )}

...
<link rel="canonical" href="https://muunsaju.com/guide" />
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        ...
        >
          ...
          <p className="text-[#5a5a56] text-base md:text-lg max-w-2xl mx-auto">
          ...
          <button
            ...
            className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold border transition-all min-h-[40px] active:scale-[0.97] ${
              selectedCategory === null
                ...
                : 'bg-black/[0.05] border-black/10 text-[#5a5a56] hover:bg-black/[0.06] hover:text-[#1a1a18] hover:border-black/10'
            }`}
          >
        ...
        <div className="space-y-4">
          {isLoading ? (
            <div className="text-center py-12">
              <p className="text-[#5a5a56]">칼럼을 불러오는 중입니다...</p>
            </div>
            ...
            displayedColumns.map((column, index) => (
              ...
              >
                <Link href={`/guide/${column.slug || column.id}`}>
                  ...
                  >
                    <div className="bg-black/[0.05] border border-black/10 rounded-2xl overflow-hidden hover:border-primary/30 hover:bg-black/[0.06] transition-all p-6 md:p-8">
                      <div className="flex flex-col md:flex-row gap-6">
                        ...
                        <div className="relative w-full md:w-48 h-40 md:h-32 rounded-xl overflow-hidden flex-shrink-0 bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center">
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-purple-500/10 flex items-center justify-center text-[#999891] text-xs font-semibold pointer-events-none">
                        ...
                        <div className="flex-1 flex flex-col justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-3 flex-wrap">
                              <span className={`px-2.5 py-1 rounded-full text-xs font-semibold ${COLUMN_CATEGORIES[column.category as keyof typeof COLUMN_CATEGORIES]?.color || 'bg-black/06 text-[#5a5a56]'}`}>
                                {column.categoryLabel}
                              </span>
                              <span className="text-xs text-[#999891]">{column.author}</span>
                            </div>
                            
                            <h3 className="text-lg md:text-xl font-bold text-[#1a1a18] mb-2 group-hover:text-primary transition-colors line-clamp-2">
                              {column.title}
                            </h3>
                            
                            <p className="text-[#5a5a56] text-sm md:text-base line-clamp-2">
                              {column.description}
                            </p>
                          </div>

                          <div className="flex items-center gap-4 mt-4 text-xs md:text-sm text-[#999891]">
            ...
            <div className="text-center py-12">
              <p className="text-[#5a5a56]">해당 카테고리의 칼럼이 없습니다.</p>
            </div>
          )}
        </div>
        ...
        >
          ...
          <p className="text-[#5a5a56] mb-6 max-w-xl mx-auto">

...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-20 antialiased">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-2xl bg-background/60 border-b border-black/10">
      ...
      <main className="container mx-auto max-w-[1280px] px-4 py-16 md:py-24">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="glass-panel border-black/10 p-10 space-y-6">
              <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center">
                <Info className="w-6 h-6 text-primary" />
              </div>
              <h3 className="text-2xl font-bold text-[#1a1a18]">무운의 의미</h3>
            ...
            <Card className="glass-panel border-black/10 p-10 space-y-6">
              ...
              <h3 className="text-2xl font-bold text-[#1a1a18]">따뜻한 위로</h3>
              <p className="text-muted-foreground leading-relaxed">
          ...
          <section className="glass-panel border-black/10 p-10 md:p-16 rounded-[3rem] space-y-10">
            <div className="max-w-2xl space-y-6">
              <h3 className="text-3xl font-bold text-[#1a1a18]">무운의 핵심 가치와 전문성</h3>
              ...
              <div className="space-y-4 pt-4">
                <h4 className="text-xl font-bold text-[#1a1a18]">왜 무운을 신뢰할 수 있나요?</h4>
            ...
            <div className="pt-8 border-t border-black/10 grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex gap-6">
                <div className="flex-shrink-0 w-12 h-12 rounded-full bg-blue-500/10 flex items-center justify-center">
                  <Shield className="w-6 h-6 text-blue-400" />
                </div>
                <div className="space-y-2">
                  <h4 className="text-lg font-bold text-[#1a1a18]">철저한 익명성</h4>
              ...
              <div className="flex gap-6">
                ...
                <div className="space-y-2">
                  <h4 className="text-lg font-bold text-[#1a1a18]">완전 무료</h4>
          ...
          <section className="text-center space-y-10 pb-10">
            <h3 className="text-3xl font-bold text-[#1a1a18]">지금 바로 당신의 운명을 확인해보세요.</h3>
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/yearly-fortune">
                <Button variant="outline" className="border-black/10 text-[#1a1a18] hover:bg-black/[0.05] px-10 py-7 rounded-2xl font-bold text-lg transition-all active:scale-95">
                  올해운세 보기
                </Button>
              </Link>
            </div>

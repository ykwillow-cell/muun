                ...
                <Card className="bg-white/[0.03] border-white/10">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <Label className="text-white/70 text-sm">가족 관계</Label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <ToggleGroup
                          ...
                          className="w-full h-10 bg-white/5 p-1 rounded-xl border border-white/10 grid grid-cols-2 gap-1"
                        >
                          <ToggleGroupItem value="male" className="rounded-lg text-xs data-[state=on]:bg-blue-500/30 data-[state=on]:text-blue-300">남성</ToggleGroupItem>
                          <ToggleGroupItem value="female" className="rounded-lg text-xs data-[state=on]:bg-pink-500/30 data-[state=on]:text-pink-300">여성</ToggleGroupItem>
                        </ToggleGroup>
                      </div>
                    </div>
                    ...
                    {/* 양력/음력 */}
                    <div className="space-y-1.5">
                      <Label className="text-white/70 text-sm">날짜 구분</Label>
                      <ToggleGroup
                        type="single"
                        ...
                        className="w-full h-10 bg-white/5 p-1 rounded-xl border border-white/10 grid grid-cols-2 gap-1"
                      >
                        <ToggleGroupItem value="solar" className="rounded-lg text-xs data-[state=on]:bg-primary/30 data-[state=on]:text-primary">양력</ToggleGroupItem>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-xs text-white/40 bg-white/5 px-2 py-0.5 rounded-full">{member.role}</span>
                        </div>
                        ...
                        <div className="flex gap-1 mt-2">
                          {balance.map((b, bi) => (
                            <div key={bi} className="flex-1">
                              ...
                              <span className="text-[10px] text-white/40 block text-center mt-0.5">{ELEMENT_KOREAN[b.name] || b.name}</span>
                            </div>
                          ))}
                        </div>
                      </div>
          ...
          <Card className="bg-white/[0.03] border-white/10">
            <CardContent className="pt-4 pb-4 space-y-4">
              ...
              <div className="mt-3 p-3 rounded-lg bg-primary/5 border border-primary/10">
                <p className="text-sm text-white/70 leading-relaxed">{familyBalance.advice}</p>
              </div>
            </CardContent>
          </Card>
        </motion.section>
        ...
        <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
          ...
          <Card className="bg-white/[0.03] border-white/10">
            <CardContent className="pt-4 pb-4 space-y-4">
              {/* 강점 */}
              <div>
                <h3 className="text-sm font-bold text-green-400 flex items-center gap-1.5 mb-2">
                ...
                <div className="space-y-2">
                  {familySummary.strengths.map((s, i) => (
                    <p key={i} className="text-sm text-white/70 leading-relaxed pl-7">{s}</p>
                  ))}
                </div>
              </div>
              ...
              {/* 개선점 */}
              <div>
                <h3 className="text-sm font-bold text-yellow-400 flex items-center gap-1.5 mb-2">
              ...
              <div className="p-3 rounded-lg bg-primary/5 border border-primary/10">
                <h3 className="text-sm font-bold text-primary flex items-center gap-1.5 mb-1">
                  <Sparkles className="w-4 h-4" />
                  가족에게 추천하는 활동
                </h3>
                <p className="text-sm text-white/70">{familySummary.luckyActivity}</p>
              </div>
            </CardContent>
          </Card>
        </motion.section>
        ...
        <CardContent className="pt-4 pb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">{member1.name}</span>
              <ArrowRight className="w-3 h-3 text-white/30" />
              <span className="text-base">{ROLE_OPTIONS.find(r => r.value === member2.role)?.icon}</span>
              <span className="text-sm font-medium text-white">{member2.name}</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <p className="text-xs text-white/50 mt-1">{analysis.title}</p>
        </CardContent>
      </button>
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="px-6 pb-4 space-y-3 border-t border-white/5 pt-3">
              ...
              <div className="p-3 rounded-lg bg-primary/5 border border-primary/10">
                ...
                <p className="text-sm text-white/70 leading-relaxed">{analysis.advice}</p>
              </div>
            </div>
          </motion.div>
        )}

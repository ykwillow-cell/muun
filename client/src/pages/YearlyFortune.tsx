...
function generate2026DetailedFortune(saju: SajuResult): {
  ...
  const yearAnalysisMap: Record<string, string> = {
    '木': `2026년은 병오년(丙午年), 즉 붉은 말의 해입니다. 올해의 주인공인 병화(丙火)와 오화(午火)는 모두 불(火)의 기운을 가지고 있어, 열정과 활력이 넘치는 한 해가 됩니다.\n\n${withReading(dayStem)} 일간이신 당신에게 올해는 "목생화(木生火)"의 원리가 작용합니다. 이것은 쉽게 말해, 나무(木)가 불(火)을 키워주는 관계입니다. 당신의 기운이 세상을 밝히는 빛이 되는 해라고 할 수 있습니다.\n\n구체적으로 말하면, 당신이 가진 재능과 능력이 세상에 알려지고 인정받는 시기입니다. 그동안 묵묵히 준비해온 것들이 드디어 빛을 발하게 됩니다. 특히 상반기(1~6월)에 중요한 전환점이 있을 수 있으니, 기회가 왔을 때 주저하지 마세요.\n\n다만 주의할 점이 있습니다. 나무가 불에 타면 재가 되듯이, 지나치게 에너지를 소모하면 번아웃이 올 수 있습니다. 열정을 쏟되, 반드시 충분한 휴식을 취하세요. 건강 관리가 올해의 핵심 과제입니다.`,
    '火': `2026년은 병오년(丙午年), 붉은 말의 해입니다. 천간 병화(丙火)와 지지 오화(午火)가 모두 불(火)의 기운이므로, 올해는 불의 기운이 매우 강한 해입니다.\n\n${withReading(dayStem)} 일간이신 당신에게 올해는 "비겁(比劫)"의 해입니다. 쉽게 말하면, 나와 같은 기운이 강해지는 해라는 뜻입니다. 이는 두 가지 의미를 가집니다.\n\n좋은 면으로는, 당신의 존재감과 영향력이 극대화됩니다. 리더십을 발휘할 기회가 많아지고, 대중적 인기나 명예가 상승합니다. 같은 뜻을 가진 동료들과의 협력에서 큰 시너지를 낼 수 있습니다.\n\n주의할 면으로는, 같은 기운이 강하다는 것은 경쟁도 치열해진다는 의미입니다. 라이벌이 등장하거나, 재물의 유출이 있을 수 있습니다. 투자나 큰 지출은 신중하게 결정하세요.\n\n건강 면에서는 "과열"에 주의해야 합니다. 심장, 혈압, 눈 건강에 특히 신경 쓰고, 충분한 수분 섭취와 휴식이 필요합니다.`,
    '土': `2026년은 병오년(丙午年), 붉은 말의 해입니다. 올해의 기운인 병화(丙火)와 오화(午火)는 모두 불(火)의 기운입니다.\n\n${withReading(dayStem)} 일간이신 당신에게 올해는 "화생토(火生土)"의 원리가 작용합니다. 불(火)이 흙(土)을 만들어주는 관계로, 쉽게 말하면 외부에서 당신에게 기운과 도움이 들어오는 해입니다.\n\n이것은 매우 좋은 기운입니다. 주변 사람들의 지원과 격려가 당신을 더욱 강하게 만들어주며, 새로운 기회가 자연스럽게 찾아옵니다. 특히 부동산, 안정적인 투자, 기반 확장에 유리한 해입니다.\n\n인간관계에서도 든든한 지원군을 얻게 됩니다. 멘토나 조력자가 나타날 수 있으니, 새로운 만남에 열린 마음을 가지세요.\n\n다만 화(火)의 기운이 강해 조급해질 수 있습니다. 당신의 가장 큰 장점인 신중함과 안정감을 유지하면서, 기회를 잡으세요.`,
    '金': `2026년은 병오년(丙午年), 붉은 말의 해입니다. 올해의 기운인 병화(丙火)와 오화(午火)는 모두 불(火)의 기운입니다.\n\n${withReading(dayStem)} 일간이신 당신에게 올해는 "화극금(火克金)"의 원리가 작용합니다. 불(火)이 쇠(金)를 녹이는 관계로, 외부의 압박이나 도전이 있을 수 있는 해입니다.\n\n하지만 걱정하지 마세요. 쇠가 불에 단련되면 더 강한 강철이 되듯이, 올해의 시련은 당신을 더욱 단단하게 만들어줍니다. 중요한 것은 정면 돌파보다는 지혜로운 우회 전략을 사용하는 것입니다.\n\n올해는 내실을 다지는 데 집중하세요. 화려한 성과보다는 실력을 쌓고, 인맥을 관리하며, 건강을 챙기는 것이 현명합니다. 하반기(7~12월)부터는 상황이 호전되기 시작하니, 상반기를 잘 견디면 좋은 결과가 옵니다.\n\n건강 면에서는 호흡기, 피부, 스트레스 관리에 특히 신경 쓰세요.`,
    '水': `2026년은 병오년(丙午年), 붉은 말의 해입니다. 올해의 기운인 병화(丙火)와 오화(午火)는 모두 불(火)의 기운입니다.\n\n${withReading(dayStem)} 일간이신 당신에게 올해는 "수극화(水克火)"의 원리가 작용합니다. 물(水)이 불(火)을 끄는 관계로, 당신이 올해의 기운을 제어하는 위치에 있습니다.\n\n이것은 당신의 지혜와 통찰력이 빛을 발하는 해라는 의미입니다. 주변에서 당신의 판단과 조언을 구하는 사람이 많아지고, 중요한 결정에서 핵심적인 역할을 맡게 됩니다.\n\n특히 올해는 정보와 지식을 활용한 활동에서 큰 성과를 거둘 수 있습니다. 연구, 분석, 컨설팅, IT 관련 분야에서 좋은 기회가 있습니다.\n\n다만 불(火)의 기운과 대립하면서 에너지 소모가 클 수 있습니다. 충분한 휴식과 재충전이 필요하며, 신장과 방광 건강에 주의하세요.`
  };

  const wealthMap: Record<string, string> = {
    '木': `올해 재물운은 "식상생재(食傷生財)"의 흐름이 있어, 당신의 재능과 노력이 직접적으로 수입으로 연결되는 해입니다.\n\n상반기에는 새로운 수입원이 생길 가능성이 높습니다. 특히 교육, 컨설팅, 창작 활동 등 당신의 전문성을 활용한 부수입이 기대됩니다. 투자보다는 실력으로 벌어들이는 소득이 유리합니다.\n\n하반기에는 안정적인 재물 흐름이 이어집니다. 다만 9~10월경에 예상치 못한 지출이 있을 수 있으니, 비상금을 준비해두세요.\n\n올해 재물 관리의 핵심은 "씨앗을 뿌리되 조급하게 수확하지 않는 것"입니다. 장기적인 관점에서 투자하고, 단기 수익에 현혹되지 마세요.`,
    '火': `올해 재물운은 비겁(比劫)의 영향으로 들어오는 돈도 많지만 나가는 돈도 많은 해입니다.\n\n수입 면에서는 당신의 인기와 명예가 재물로 연결됩니다. 강연, 방송, SNS 활동 등 대중과 소통하는 활동에서 수입이 기대됩니다.\n\n지출 면에서는 사교비, 경조사비 등 인간관계 관련 지출이 늘어날 수 있습니다. 또한 경쟁자의 등장으로 예상치 못한 비용이 발생할 수 있으니 주의하세요.\n\n올해 재물 관리의 핵심은 "수입의 30%는 반드시 저축하는 것"입니다. 들어오는 대로 쓰면 남는 것이 없을 수 있으니, 계획적인 재무 관리가 필요합니다.`,
    '土': `올해 재물운은 화생토(火生土)의 기운으로 매우 좋습니다. 외부에서 재물이 들어오는 흐름이 있어, 안정적인 수입 증가가 기대됩니다.\n\n특히 부동산, 실물 자산, 안정적인 투자에서 좋은 결과를 얻을 수 있습니다. 4~5월과 9~10월에 좋은 투자 기회가 있을 수 있으니 주목하세요.\n\n직장인이라면 연봉 인상이나 보너스를 기대할 수 있고, 사업자라면 매출 증가가 예상됩니다.\n\n올해 재물 관리의 핵심은 "안정적인 자산을 늘리는 것"입니다. 투기성 투자보다는 실물 자산이나 안정적인 금융 상품에 집중하세요.`,
    '金': `올해 재물운은 화극금(火克金)의 영향으로 다소 도전적입니다. 예상치 못한 지출이나 투자 손실에 주의가 필요합니다.\n\n상반기에는 재물의 유출이 있을 수 있습니다. 큰 투자나 보증은 피하고, 현금 유동성을 확보해두세요. 충동적인 소비도 자제해야 합니다.\n\n하반기부터는 상황이 호전됩니다. 특히 8~9월에 좋은 수입 기회가 찾아올 수 있으니, 그때를 위해 실력을 갈고닦으세요.\n\n올해 재물 관리의 핵심은 "지키는 것이 버는 것"입니다. 공격적인 투자보다는 수비적인 재무 전략이 유리합니다.`,
    '水': `올해 재물운은 수극화(水克火)의 기운으로, 당신의 지혜가 재물로 연결되는 해입니다.\n\n정보와 지식을 활용한 수입이 유리합니다. 컨설팅, 분석, 교육, IT 관련 분야에서 좋은 수입을 기대할 수 있습니다. 특히 3~4월과 8~9월에 좋은 기회가 있습니다.\n\n투자에서는 정보력이 핵심입니다. 충분한 조사와 분석을 바탕으로 한 투자는 좋은 결과를 가져오지만, 감에 의존한 투자는 피하세요.\n\n올해 재물 관리의 핵심은 "정보가 곧 돈"이라는 것입니다. 트렌드를 읽고, 시장의 흐름을 파악하는 데 시간을 투자하세요.`
  };

  const careerMap: Record<string, string> = {
    '木': `올해 직업운은 당신의 성장과 발전이 돋보이는 해입니다. 새로운 프로젝트나 역할을 맡게 될 가능성이 높으며, 이를 통해 실력을 인정받게 됩니다.\n\n직장인이라면 승진이나 부서 이동의 기회가 있을 수 있습니다. 새로운 환경에서도 빠르게 적응하여 좋은 성과를 낼 수 있으니, 변화를 두려워하지 마세요.\n\n사업자라면 사업 확장이나 새로운 분야 진출을 고려해볼 만합니다. 다만 무리한 확장보다는 단계적인 성장이 안전합니다.\n\n취업 준비생이라면 교육, 문화, 환경 관련 분야에서 좋은 기회가 있습니다.`,
    '火': `올해 직업운은 당신의 카리스마와 리더십이 빛나는 해입니다. 조직 내에서 중요한 역할을 맡거나, 대외적으로 주목받는 기회가 많아집니다.\n\n직장인이라면 프레젠테이션, 협상, 대외 업무에서 뛰어난 성과를 거둘 수 있습니다. 팀을 이끄는 역할이 주어질 수 있으니, 리더십을 발휘하세요.\n\n사업자라면 마케팅과 브랜딩에 투자하면 좋은 결과를 얻습니다. SNS나 미디어를 활용한 홍보가 효과적입니다.\n\n다만 경쟁이 치열해질 수 있으니, 실력으로 승부하세요.`,
    '土': `올해 직업운은 안정적인 성장이 기대되는 해입니다. 화생토(火生土)의 기운으로 상사나 선배의 지원을 받아 순조롭게 발전합니다.\n\n직장인이라면 신뢰를 바탕으로 한 꾸준한 성과가 인정받습니다. 특히 관리직이나 중재자 역할에서 빛을 발합니다.\n\n사업자라면 기존 사업의 안정화와 내실 강화에 집중하면 좋은 결과를 얻습니다. 새로운 파트너십도 기대할 수 있습니다.\n\n부동산, 건설, 식품, 교육 관련 분야에서 특히 좋은 기회가 있습니다.`,
    '金': `올해 직업운은 도전과 성장이 공존하는 해입니다. 화극금(火克金)의 기운으로 외부의 압박이 있지만, 이를 통해 더욱 단련됩니다.\n\n직장인이라면 업무량이 늘어나거나 어려운 프로젝트를 맡게 될 수 있습니다. 하지만 이를 잘 해내면 큰 인정을 받게 됩니다.\n\n사업자라면 경쟁이 치열해질 수 있으니, 차별화 전략에 집중하세요. 품질과 전문성으로 승부하면 좋은 결과를 얻습니다.\n\n하반기부터 상황이 호전되니, 상반기에는 실력을 쌓는 데 집중하세요.`,
    '水': `올해 직업운은 당신의 지혜와 전문성이 빛나는 해입니다. 수극화(水克火)의 기운으로 복잡한 상황에서 해결사 역할을 하게 됩니다.\n\n직장인이라면 분석, 기획, 전략 수립 등의 업무에서 뛰어난 성과를 거둡니다. 상사의 신뢰를 얻어 중요한 프로젝트에 참여할 기회가 있습니다.\n\n사업자라면 정보와 데이터를 활용한 의사결정이 좋은 결과를 가져옵니다. IT, 교육, 컨설팅 분야에서 새로운 기회가 있습니다.\n\n해외 관련 업무나 글로벌 프로젝트에서도 좋은 성과를 기대할 수 있습니다.`
  };

  const loveMap: Record<string, string> = {
    '木': `올해 애정운은 새로운 만남과 성장이 기대되는 해입니다. 목생화(木生火)의 기운으로 당신의 매력이 빛나며, 주변의 관심을 끌게 됩니다.\n\n미혼이라면 3~5월, 9~10월에 좋은 인연을 만날 가능성이 높습니다. 학습 모임, 동호회, 직장 내에서 자연스러운 만남이 기대됩니다.\n\n기혼이라면 배우자와의 관계가 더욱 깊어지는 해입니다. 함께 새로운 것을 배우거나 여행을 계획하면 관계가 더욱 돈독해집니다.\n\n다만 지나친 열정이 상대방을 부담스럽게 할 수 있으니, 적절한 거리감을 유지하세요.`,
    '火': `올해 애정운은 열정적이지만 변동이 큰 해입니다. 화(火)의 기운이 강해 감정의 기복이 클 수 있으니, 감정 조절에 신경 쓰세요.\n\n미혼이라면 매력이 넘치는 해이므로 만남의 기회는 많습니다. 다만 여러 사람에게 관심을 받아 선택의 어려움이 있을 수 있습니다. 진심으로 마음이 가는 사람에게 집중하세요.\n\n기혼이라면 배우자와의 소통에 더 신경 쓰세요. 바쁜 일정 속에서도 함께하는 시간을 만들어야 합니다.\n\n6~7월에 감정적으로 힘든 시기가 올 수 있으니, 이때 인내심을 가지세요.`,
    '土': `올해 애정운은 안정적이고 따뜻한 해입니다. 화생토(火生土)의 기운으로 사랑이 깊어지고, 신뢰가 쌓이는 시기입니다.\n\n미혼이라면 진지한 만남이 기대됩니다. 특히 4~5월, 10~11월에 좋은 인연이 있을 수 있습니다. 소개팅이나 중매를 통한 만남이 유리합니다.\n\n기혼이라면 가정의 평화와 행복이 깊어지는 해입니다. 가족 여행이나 함께하는 취미 활동이 관계를 더욱 돈독하게 합니다.\n\n결혼을 고려하고 있다면 올해가 좋은 시기입니다.`,
    '金': `올해 애정운은 인내와 이해가 필요한 해입니다. 화극금(火克金)의 기운으로 감정적인 갈등이 있을 수 있지만, 이를 통해 관계가 더 성숙해집니다.\n\n미혼이라면 상반기보다는 하반기에 좋은 인연이 기대됩니다. 8~10월에 운명적인 만남이 있을 수 있으니, 마음을 열어두세요.\n\n기혼이라면 배우자와의 의견 충돌이 있을 수 있습니다. 자신의 주장만 고집하지 말고, 상대방의 입장에서 생각해보세요.\n\n올해 애정운의 핵심은 "부드러움이 강함을 이긴다"는 것입니다.`,
    '水': `올해 애정운은 깊고 의미 있는 관계가 기대되는 해입니다. 지적인 교감과 정서적 유대가 깊어지는 시기입니다.\n\n미혼이라면 지적인 대화를 나눌 수 있는 상대를 만날 가능성이 높습니다. 독서 모임, 학습 그룹, 온라인 커뮤니티에서 좋은 인연이 있을 수 있습니다.\n\n기혼이라면 배우자와의 정서적 교감이 깊어지는 해입니다. 서로의 꿈과 목표에 대해 진지하게 이야기하는 시간을 가지세요.\n\n3~4월과 9~10월에 애정운이 특히 좋습니다.`
  };

  const healthMap: Record<string, string> = {
    '木': `올해 건강운에서 가장 주의해야 할 부분은 간(肝)과 눈 건강입니다. 목(木)은 간과 눈을 관장하는데, 화(火)의 기운이 강한 올해는 에너지 소모가 커서 간에 부담이 갈 수 있습니다.\n\n충분한 수면과 규칙적인 식사가 기본입니다. 특히 녹색 채소와 신맛 나는 과일을 많이 섭취하면 간 건강에 도움이 됩니다.\n\n스트레스 관리도 중요합니다. 산책, 요가, 명상 등 자연 속에서 하는 활동이 심신 안정에 효과적입니다.\n\n4~5월과 10~11월에 건강에 특히 주의하세요. 무리한 일정은 피하고, 정기 검진을 받는 것이 좋습니다.`,
    '火': `올해 건강운에서 가장 주의해야 할 부분은 심장과 혈압입니다. 화(火)의 기운이 매우 강한 올해는 "과열"에 주의해야 합니다.\n\n규칙적인 운동과 충분한 수분 섭취가 필수입니다. 특히 유산소 운동보다는 요가, 수영 등 심신을 안정시키는 운동이 좋습니다.\n\n매운 음식이나 자극적인 음식은 줄이고, 쓴맛 나는 채소(여주, 셀러리 등)를 섭취하면 심장 건강에 도움이 됩니다.\n\n5~7월에 건강에 특히 주의하세요. 더위에 약할 수 있으니, 여름철 건강 관리에 신경 쓰세요.`,
    '土': `올해 건강운은 비교적 양호합니다. 화생토(火生土)의 기운이 당신의 건강을 지원해주기 때문입니다.\n\n다만 소화기 건강에는 주의가 필요합니다. 토(土)는 비장과 위장을 관장하므로, 규칙적인 식사와 균형 잡힌 식단이 중요합니다.\n\n단맛 나는 음식(고구마, 단호박 등)을 적절히 섭취하면 비장 건강에 도움이 됩니다. 과식은 피하세요.\n\n규칙적인 생활 습관을 유지하면 올해 건강하게 보낼 수 있습니다. 계절이 바뀌는 3월, 6월, 9월, 12월에 건강 점검을 하면 좋습니다.`,
    '金': `올해 건강운에서 가장 주의해야 할 부분은 호흡기와 피부입니다. 화극금(火克金)의 기운으로 폐와 대장에 부담이 갈 수 있습니다.\n\n맑은 공기를 마시는 것이 중요합니다. 공기청정기를 사용하고, 미세먼지가 심한 날은 외출을 자제하세요. 호흡 운동이나 명상이 폐 건강에 도움이 됩니다.\n\n매운맛 나는 음식(무, 생강, 배)을 적절히 섭취하면 폐 건강에 좋습니다. 피부 보습에도 신경 쓰세요.\n\n5~7월에 건강에 특히 주의하세요. 스트레스가 건강에 직접적인 영향을 미치니, 적절한 해소 방법을 찾으세요.`,
    '水': `올해 건강운에서 가장 주의해야 할 부분은 신장과 방광 건강입니다. 수(水)가 화(火)와 대립하면서 에너지 소모가 클 수 있습니다.\n\n충분한 수분 섭취가 가장 중요합니다. 하루 8잔 이상의 물을 마시고, 카페인 섭취는 줄이세요. 검은콩, 해조류, 견과류 등이 신장 건강에 도움이 됩니다.\n\n보온에도 신경 쓰세요. 특히 하체를 따뜻하게 유지하는 것이 중요합니다. 족욕이나 반신욕이 건강에 좋습니다.\n\n1~2월과 11~12월에 건강에 특히 주의하세요. 충분한 휴식과 수면이 건강의 기본입니다.`
  };
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      >
                        <ToggleGroupItem value="male" className="h-full rounded-lg data-[state=on]:bg-primary data-[state=on]:text-primary-foreground text-white/70 transition-all font-medium text-sm">
                          남성
                        </ToggleGroupItem>
                        <ToggleGroupItem value="female" className="h-full rounded-lg data-[state=on]:bg-primary data-[state=on]:text-primary-foreground text-white/70 transition-all font-medium text-sm">
                          여성
                        </ToggleGroupItem>
                      </ToggleGroup>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="space-y-2">
                        <Input
                          ...
                          className={`h-11 bg-white/5 border-white/10 text-white rounded-xl focus:ring-primary/50 focus:border-primary transition-all text-sm ${form.watch("birthTimeUnknown") ? 'opacity-40' : ''}`}
                        />
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <ToggleGroupItem value="solar" className="h-full rounded-lg data-[state=on]:bg-primary data-[state=on]:text-primary-foreground text-white/70 transition-all font-medium text-sm">
                        양력
                      </ToggleGroupItem>
                      <ToggleGroupItem value="lunar" className="h-full rounded-lg data-[state=on]:bg-primary data-[state=on]:text-primary-foreground text-white/70 transition-all font-medium text-sm">
                        음력
                      </ToggleGroupItem>
                    </ToggleGroup>
        ...
        >
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                    <div className="bg-green-500/5 border border-green-500/10 rounded-xl p-3">
                      <p className="text-xs font-bold text-green-400 mb-2">강점</p>
                    ...
                    <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-3">
                      <p className="text-xs font-bold text-red-400 mb-2">주의점</p>
                      <ul className="space-y-1">
                  ...
                  <div className="bg-yellow-500/5 border border-yellow-500/10 rounded-xl p-3">
                    <p className="text-xs font-bold text-yellow-400 mb-1">전문가 조언</p>
                    <p className="text-xs text-white/70 leading-relaxed">{stemPersonality.advice}</p>
                  </div>
                </CardContent>
              </Card>
            </section>
                  ...
                  {elementBalance.map((element) => {
                    ...
                    return (
                      <div key={element.name} className="flex items-center gap-3">
                        <span className={`w-12 text-center font-bold text-sm ${color}`}>
                        ...
                        <span className="w-16 text-right text-xs text-white/60">{element.value}개 ({percentage}%)</span>
                      </div>
                    );
                  })}
                </div>
                <div className="bg-white/5 rounded-xl p-3 space-y-2">
                  <p className="text-sm text-white/80 leading-relaxed">{balanceAnalysis.analysis}</p>
                  {balanceAnalysis.supplement && (
                    <p className="text-xs text-white/60 leading-relaxed">{balanceAnalysis.supplement}</p>
                  )}
                </div>
              </CardContent>
            </Card>
            ...
            <section className="space-y-3">
              ...
              <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                <CardContent className="p-4">
                  <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{detailedFortune.wealthFortune}</p>
                </CardContent>
              </Card>
            </section>
          )}
          ...
          {detailedFortune && (
            <section className="space-y-3">
              ...
              <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                <CardContent className="p-4">
                  <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{detailedFortune.careerFortune}</p>
                </CardContent>
              </Card>
            </section>
          )}
          ...
          {detailedFortune && (
            <section className="space-y-3">
              ...
              <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                <CardContent className="p-4">
                  <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{detailedFortune.loveFortune}</p>
                </CardContent>
              </Card>
            </section>
          )}
          ...
          {detailedFortune && (
            <section className="space-y-3">
              ...
              <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                <CardContent className="p-4">
                  <p className="text-sm text-white/80 leading-relaxed whitespace-pre-line">{detailedFortune.healthFortune}</p>
                </CardContent>
              </Card>
            </section>
          )}
                    ...
                    <div key={m.month} className="border border-white/5 rounded-xl overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <span className="text-sm font-bold text-white w-8">{m.month}월</span>
                        ...
                        {expandedMonths.has(m.month) && (
                          ...
                          >
                            <div className="px-3 pb-3 pt-1 border-t border-white/5">
                              <p className="text-xs text-white/70 leading-relaxed">{m.content}</p>
                            </div>
                          </motion.div>
                        )}
                      </AnimatePresence>
              ...
              <Card className="bg-white/5 border-white/10 rounded-2xl overflow-hidden">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-white/80 leading-relaxed">
                    {(iljuData as Record<string, string>)[`${result.dayPillar.stem}${result.dayPillar.branch}`] || 
                     "일주 정보를 불러올 수 없습니다."}
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="space-y-2 pt-2">
            ...
            <Button
              ...
              className="w-full h-12 text-white/60 hover:text-white hover:bg-white/5 font-medium rounded-xl text-sm"
            >
              다른 정보로 다시 보기
            </Button>
          </div>

            ...
            <CardContent className="p-8 space-y-6 text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong className="text-white">핵심 기능 제공:</strong> 사용자가 입력한 생년월일, 태어난 시간, 성별 등의 정보는
                    오직 사주 및 운세 결과를 계산하고 사용자에게 표시하기 위한 목적으로만 사용됩니다.
                  </li>
                  <li>
                    <strong className="text-white">서비스 개선 및 통계 분석:</strong> 서비스 품질 향상, 사용자 경험 최적화, 신규 서비스 개발 등을 위해
                    접속 로그, 쿠키, 행태정보 등 비식별 데이터를 통계적으로 분석하고 활용합니다.
                  </li>
                  <li>
                    <strong className="text-white">광고 제공:</strong> 구글 애드센스를 통해 맞춤형 광고를 제공하고 서비스 운영 수익을 창출합니다.
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">2. 처리하는 개인정보 항목 및 수집 방법</h3>
                <p>
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="border-b border-white/10">
                        <th className="text-left py-2 pr-4 text-white font-semibold w-1/4">구분</th>
                        <th className="text-left py-2 pr-4 text-white font-semibold w-2/4">수집 항목</th>
                        <th className="text-left py-2 text-white font-semibold w-1/4">수집 방법</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-white/5">
                        <td className="py-2 pr-4 text-white font-medium align-top">사용자 직접 입력</td>
                        <td className="py-2 pr-4 align-top">이름(별칭), 성별, 생년월일, 태어난 시간</td>
                        <td className="py-2 align-top">사용자가 서비스 내에서 직접 입력</td>
                      </tr>
                      <tr>
                        <td className="py-2 pr-4 text-white font-medium align-top">자동 수집</td>
              ...
              <section className="space-y-3">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong className="text-white">사용자 입력 정보:</strong> 사용자의 편의를 위해 브라우저의 로컬 스토리지(Local Storage)에 임시 저장됩니다.
                    이 정보는 서버에 영구적으로 저장되지 않으며, 사용자가 브라우저의 캐시를 직접 삭제하면 정보는 즉시 파기됩니다.
                  </li>
                  <li>
                    <strong className="text-white">자동 수집 정보:</strong> 통계 분석 및 서비스 개선 목적으로 최대 1년간 보관 후 복구 불가능한 방법으로 파기됩니다.
                  </li>
                </ul>
              </section>
              ...
              {/* 4. 제3자 제공 및 위탁 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">4. 개인정보의 제3자 제공 및 처리 위탁</h3>
                <p>
              ...
              {/* 4-1. Google AdSense */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">4-1. Google AdSense 광고 서비스</h3>
                <p>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">4-2. Microsoft Clarity 분석 도구</h3>
                <p>
              ...
              {/* 5. 정보주체의 권리 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">5. 정보주체와 법정대리인의 권리·의무 및 그 행사방법</h3>
                <p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    <strong className="text-white">쿠키 설정 거부:</strong> 사용자는 웹 브라우저의 옵션을 설정함으로써 모든 쿠키를 허용하거나,
                    쿠키가 저장될 때마다 확인을 거치거나, 모든 쿠키의 저장을 거부할 수 있습니다.
                    (설정방법 예시: Chrome의 경우 → 웹 브라우저 우측 상단 '더보기' &gt; 설정 &gt; 개인정보 및 보안 &gt; 쿠키 및 기타 사이트 데이터)
                  </li>
                  <li>
                    <strong className="text-white">로컬 스토리지 삭제:</strong> 사용자는 브라우저 설정 메뉴를 통해 로컬 스토리지에 저장된 정보를 직접 삭제할 수 있습니다.
                  </li>
                </ul>
              </section>
              ...
              {/* 6. 개인정보의 파기 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">6. 개인정보의 파기</h3>
                <p>
              ...
              {/* 7. 안전성 확보 조치 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">7. 개인정보의 안전성 확보 조치</h3>
                <p>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li><strong className="text-white">기술적 조치:</strong> 개인정보처리시스템 등의 접근권한 관리, 보안프로그램 설치</li>
              ...
              {/* 8. 개인정보 보호책임자 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">8. 개인정보 보호책임자</h3>
                <p>
                  회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여
                  아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  <li><strong className="text-white">회사명:</strong> Yu Lab</li>
                  <li><strong className="text-white">대표자:</strong> Yu, Yeonggyeong</li>
                  <li>
              ...
              {/* 9. 정책 변경 */}
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">9. 개인정보 처리방침 변경</h3>
                <p>
                  본 개인정보처리방침은 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터
                  공지사항을 통하여 고지할 것입니다.
                </p>
                <p>
                  <strong className="text-white">시행일:</strong> 2026년 3월 6일
                </p>
              </section>

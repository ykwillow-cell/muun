          ...
          <Card className="bg-card border-white/10">
            <CardContent className="p-8 space-y-6 text-muted-foreground leading-relaxed">
              ...
              <section className="space-y-3">
                ...
                <p>
                  서비스는 사용자의 개인정보를 외부에 제공하거나 처리를 위탁하지 않습니다. 다만, 구글 애드센스 및 마이크로소프트 Clarity 등 외부 분석/광고 서비스 이용 시 비식별화된 통계 및 행태 정보가 활용될 수 있습니다.
                </p>
              </section>
              ...
              <section className="space-y-3">
                <h3 className="text-xl font-bold text-white">4-2. Microsoft Clarity 분석 도구 사용 고지</h3>
                <p>
                  본 서비스는 서비스 개선 및 사용자 경험 최적화를 위해 **Microsoft Clarity**를 사용합니다. Microsoft Clarity의 데이터 수집 및 처리 방식에 대한 자세한 내용은 <a href="https://clarity.microsoft.com/privacy" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Microsoft Clarity 개인정보 페이지</a> 및 <a href="https://privacy.microsoft.com/ko-kr/privacystatement" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Microsoft 개인정보처리방침</a>을 참고하시기 바랍니다.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  이메일: <strong>ykwillow1@naver.com</strong>
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  본 업데이트된 개인정보처리방침은 2026년 3월 6일부터 시행됩니다.
                </p>
              </section>
            </CardContent>
          </Card>
